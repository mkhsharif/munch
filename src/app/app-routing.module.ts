...
const routes: Routes = [
  ...
  { path: 'shoutout_ids/create', component: ShoutOutCreateComponent, canActivate: []},
  { path: 'shoutout_ids/:id', component: ShoutOutDetailComponent},
  { path: 'shoutout_ids', component: ShoutOutListComponent},
  ...
  { path: 'user_id/settings', component: UserSettingsComponent },
